...
function error(startingNumber, documentsWanted, upCount, incrementAmount) {
  if (
...
function calculate(e) {
  ...
  const documentsWanted = parseInt(documents.value);
  ...
  let numberOfSheets = Math.ceil(documentsWanted / upCount); //~8
